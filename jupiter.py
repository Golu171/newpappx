...
<head>  
    ...
    .question-section {{
    position: relative;
    padding: 8px;        /* ðŸ”¥ 20px â†’ 8px (side gap à¤–à¤¤à¥à¤®) */
    margin-top: 70px;    /* ðŸ”¥ à¤¥à¥‹à¤¡à¤¼à¤¾ à¤”à¤° tight */
    margin-bottom: 90px; /* à¤¥à¥‹à¤¡à¤¼à¤¾ à¤•à¤® */
}}  
    .question-card {{ 
    ...
    <div class="quiz-header">  
        <div class="header-top">  
            ...
            <div class="header-actions" style="display:flex; gap:8px; align-items:center;">  
                <!-- ðŸ”¥ Zoom Controls Added Next to Moon Button -->
...
<div style="text-align:center; padding:20px; color:var(--text-light);">
    Made with â¤ï¸ by <b>{created_by}</b> </div>
