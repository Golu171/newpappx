...
/* 🔥 thoda aur tight */
    ...
    .question-text {{ font-size: 24px; font-weight: 600; color: var(--text-dark); line-height: 1.8; margin-bottom: 12px; white-space: pre-wrap; word-wrap: break-word; }}  
    .option-btn {{ width: 100%; padding: 18px 20px; background: var(--bg-light); border: 3px solid var(--border); border-radius: 16px; text-align: left; font-size: 24px; color: var(--text-dark);font-weight: 700; cursor: pointer; display: flex; align-items: flex-start; gap: 14px; transition: 0.3s; margin-bottom: 10px; line-height: 1.6; }}  
    ...
    <div class="quiz-header">  
        <div class="header-top">  
            ...
            <div class="header-actions" style="display:flex; gap:8px; align-items:center;">  
                ...
                <!-- 🔥 Fullscreen Button -->
                <button id="fullscreenBtn" onclick="toggleFullscreen()" title="Fullscreen" aria-label="Fullscreen" style="width:40px; height:40px; border-radius:12px; border:2px solid var(--border); background:var(--bg-light); cursor:pointer;"><i class="fas fa-expand"></i></button>  
