    ...
    <div class="quiz-header">  
        <div class="header-top">  
            ...
            <div class="header-actions" style="display:flex; gap:10px; align-items:center;">  
                <!-- ðŸ”¥ Zoom Button Added Here -->
                <button onclick="toggleZoom()" style="width:40px; height:40px; border-radius:12px; border:2px solid var(--border); background:var(--bg-light); cursor:pointer;"><i class="fas fa-search-plus"></i></button>
...
<script>  
    ...
    // ðŸ”¥ New Toggle Zoom Function
    function toggleZoom() {{
        if(state.zoom === 1) state.zoom = 1.15;
        else if(state.zoom === 1.15) state.zoom = 1.3;
        else state.zoom = 1;
