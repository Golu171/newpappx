...
<head>  
    ...
    .question-text {{ font-size: 22px; font-weight: 600; color: var(--text-dark); line-height: 1.8; margin-bottom: 24px; white-space: pre-wrap; word-wrap: break-word; }}  
    .option-btn {{ width: 100%; padding: 18px 20px; background: var(--bg-light); border: 3px solid var(--border); border-radius: 16px; text-align: left; font-size: 18px; color: var(--text-dark); cursor: pointer; display: flex; align-items: flex-start; gap: 14px; transition: 0.3s; margin-bottom: 14px; line-height: 1.6; }}  
