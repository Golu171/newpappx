...
async def get_api_url(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ EDU FIX
    if "eduguru.akamai.net.in" in api_url:
    ...
    if "akamai" in api_url:
        ...
        context.user_data['mode_headers'] = AGG_HEADERS if "hsscgurukulapi" in api_url else HSSC_HEADERS
    else:
...
async def start_upload(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    headers = context.user_data['mode_headers']   # 👈 ये add कर
