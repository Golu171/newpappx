...
async def item_selected(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if mode == "agg":
        ...
        elif mode == "series" or mode == "hssc" or ("hsscguide" in context.user_data['api_url'] and mode != "course"):
            # Series Mode: Subject based scan
            ...
            # Course / EduCourse Mode: Recursive Scan
