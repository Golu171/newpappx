...
async def handle_choice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if choice == "hssc":
        await query.edit_message_text("📡 *Fetching HSSC Series... Wait bhai*")
        try:
...
async def item_selected(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_msg = await query.edit_message_text("🕵️ *Deep Scanning Topic-Wise...*")
    all_tests = []
    try:
        if mode == "agg":
            ...
            if "hsscguide" in api_url or mode == "hssc":
