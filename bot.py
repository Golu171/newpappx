...
async def extract_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🔗 API URL bhej (e.g., revolutioneducationapi.classx.co.in):"
    )
    return API_URL
...
async def handle_choice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(
        f"📡 Scanning {choice.upper()}... wait kar bhai."
    )
...
# ---- baaki tumhara original item_selected aur start_upload yahin same rahega ----
# (Main unko change nahi kar raha kyunki tumne bola logic touch mat karo)
